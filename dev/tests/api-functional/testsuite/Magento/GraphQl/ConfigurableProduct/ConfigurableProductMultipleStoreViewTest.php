...
class ConfigurableProductMultipleStoreViewTest extends GraphQlAbstract
{
    ...
    /**
     * @magentoApiDataFixture Magento/Store/_files/second_website_with_two_stores.php
     * @magentoApiDataFixture Magento/ConfigurableProduct/_files/product_configurable_variation_in_multiple_websites.php
     */
    public function testConfigurableProductVariationAssignedToDifferentWebsites()
    {
        $headerMapFirstStore['Store'] = 'default';
        $headerMapSecondStore['Store'] = 'fixture_second_store';
        $parentSku = 'configurable';
        ...
        $firstWebsiteVariants = $responseForFirstWebsite['products']['items'][0]['variants'];
        $secondWebsiteVariants = $responseForSecondWebsite['products']['items'][0]['variants'];
        self::assertEquals(1, count($firstWebsiteVariants));
        self::assertContains('simple_10', $firstWebsiteVariants[0]['product']);
        self::assertContains('Option 1', $firstWebsiteVariants[0]['attributes'][0]);
        self::assertEquals(1, count($secondWebsiteVariants));
        self::assertContains('simple_20', $secondWebsiteVariants[0]['product']);
        self::assertContains('Option 2', $secondWebsiteVariants[0]['attributes'][0]);
    }
