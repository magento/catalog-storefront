...
QUERY;
        ...
        self::assertEquals(
            '2',
            $responseDataObject->getData('category/children/0/level')
        );
        self::assertEquals(
            'Category 1.1',
        ...
        self::assertEquals(
            'category-1-1',
            $responseDataObject->getData('category/children/0/children/0/url_key')
        );
        self::assertEquals(
            'category-1/category-1-1',
            $responseDataObject->getData('category/children/0/children/0/url_path')
        );
        self::assertEquals(
            '3',
            $responseDataObject->getData('category/children/0/children/0/level')
        );
        self::assertEquals(
            [],
...
QUERY;
    ...
    private function assertWebsites($product, $actualResponse)
    {
        ...
        $this->assertEquals($assertionMap, $actualResponse);
    }
