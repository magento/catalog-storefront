...
use Magento\CatalogBundleProduct\DataProvider\Query\Items\BundleProductItemsBuilder as QueryBuilder;

/**
 * @inheritdoc
 */
class ProductItems implements \Magento\CatalogProduct\DataProvider\DataProviderInterface
{
    /**
