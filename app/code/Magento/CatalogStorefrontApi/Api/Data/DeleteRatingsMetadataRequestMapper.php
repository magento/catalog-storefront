 ...
 */
final class DeleteRatingsMetadataRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteRatingsMetadataRequestInterface::class;
    ...
    * would be built
    *
    * @param DeleteRatingsMetadataRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(DeleteRatingsMetadataRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "ratingIds":
