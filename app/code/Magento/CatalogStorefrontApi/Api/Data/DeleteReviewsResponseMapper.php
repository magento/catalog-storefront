 ...
 */
final class DeleteReviewsResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteReviewsResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(DeleteReviewsResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
