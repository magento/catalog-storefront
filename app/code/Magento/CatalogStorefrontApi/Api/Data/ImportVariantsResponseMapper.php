 ...
 */
final class ImportVariantsResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportVariantsResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ImportVariantsResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
