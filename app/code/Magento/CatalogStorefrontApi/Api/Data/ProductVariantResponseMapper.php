 ...
 */
final class ProductVariantResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductVariantResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ProductVariantResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "matched_variants":
                $convertedArray = [];
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\CatalogStorefrontApi\Api\Data\ProductVariantMapper::class)
                        ->setData($element)
                        ->build();
                }
