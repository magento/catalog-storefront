 ...
 */
final class ProductVariantRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductVariantRequestInterface::class;
    ...
    * would be built
    *
    * @param ProductVariantRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductVariantRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "product_Id":
