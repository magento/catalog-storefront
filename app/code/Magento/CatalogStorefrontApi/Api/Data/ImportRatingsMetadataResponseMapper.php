 ...
 */
final class ImportRatingsMetadataResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportRatingsMetadataResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ImportRatingsMetadataResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
