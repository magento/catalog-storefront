 ...
 */
final class PaginationResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PaginationResponseInterface::class;
    ...
    * would be built
    *
    * @param PaginationResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(PaginationResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "page_size":
