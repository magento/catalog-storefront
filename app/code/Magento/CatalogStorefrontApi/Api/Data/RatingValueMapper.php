 ...
 */
final class RatingValueMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = RatingValueInterface::class;
    ...
    * would be built
    *
    * @param RatingValue $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(RatingValue $dto, string $key, $value): void
    {
        switch ($key) {
            case "value_id":
                $dto->setValueId((string) $value);
                break;
            case "value":
