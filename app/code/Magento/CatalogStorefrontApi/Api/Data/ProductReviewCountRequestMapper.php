...
/**
 * Autogenerated description for ProductReviewCountRequest class
 *
 ...
 */
final class ProductReviewCountRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductReviewCountRequestInterface::class;
    ...
    * would be built
    *
    * @param ProductReviewCountRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductReviewCountRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "product_id":
