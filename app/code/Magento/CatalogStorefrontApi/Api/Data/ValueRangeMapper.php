...
/**
 * Autogenerated description for ValueRange class
 *
...
final class ValueRangeMapper
{
     ...
     * @var string
     */
    private static $dtoClassName = ValueRangeInterface::class;
    ...
    * would be built
    *
    * @param ValueRange $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ValueRange $dto, string $key, $value): void
    {
        switch ($key) {
            case "from":
