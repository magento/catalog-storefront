 ...
 */
final class DeleteReviewsRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteReviewsRequestInterface::class;
    ...
    * would be built
    *
    * @param DeleteReviewsRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(DeleteReviewsRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "reviewIds":
                $dto->setReviewIds((array) $value);
                break;
            case "store":
