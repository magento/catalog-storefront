 ...
 */
final class ImportCategoryRequestAttributesMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportCategoryRequestAttributes::class;
    ...
    * would be built
    *
    * @param ImportCategoryRequestAttributes $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ImportCategoryRequestAttributes $dto, string $key, $value): void
    {
        switch ($key) {
            case "entity_id":
