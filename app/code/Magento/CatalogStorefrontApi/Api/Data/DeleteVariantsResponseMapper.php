 ...
 */
final class DeleteVariantsResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteVariantsResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(DeleteVariantsResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
