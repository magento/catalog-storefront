 ...
 */
final class ImportRatingsMetadataRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportRatingsMetadataRequestInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ImportRatingsMetadataRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "metadata":
                $convertedArray = [];
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\CatalogStorefrontApi\Api\Data\RatingMetadataMapper::class)
                        ->setData($element)
                        ->build();
                }
                $dto->setMetadata($convertedArray);
                break;
            case "store":
