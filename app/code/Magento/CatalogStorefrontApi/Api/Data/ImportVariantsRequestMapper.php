 ...
 */
final class ImportVariantsRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportVariantsRequestInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ImportVariantsRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "variants":
                $convertedArray = [];
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\CatalogStorefrontApi\Api\Data\ProductVariantImportMapper::class)
                        ->setData($element)
                        ->build();
                }
