...
/**
 * Autogenerated description for DeleteRatingsMetadataResponse class
 *
 ...
 */
final class DeleteRatingsMetadataResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteRatingsMetadataResponseInterface::class;
    ...
    * would be built
    *
    * @param DeleteRatingsMetadataResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(DeleteRatingsMetadataResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
