 ...
 */
final class ImportCategoriesRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportCategoriesRequestInterface::class;
            ...
            case "categories":
                ...
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\CatalogStorefrontApi\Api\Data\ImportCategoryDataRequestMapper::class)
                        ->setData($element)
                        ->build();
                }
                $dto->setCategories($convertedArray);
                break;
            case "store":
