 ...
 */
final class CustomerProductReviewResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = CustomerProductReviewResponseInterface::class;
    ...
    * would be built
    *
    * @param CustomerProductReviewResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(CustomerProductReviewResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "items":
                $convertedArray = [];
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\CatalogStorefrontApi\Api\Data\ReadReviewMapper::class)
                        ->setData($element)
                        ->build();
                }
