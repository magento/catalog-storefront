 ...
 */
final class MediaResourceMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = MediaResourceInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(MediaResource $dto, string $key, $value): void
    {
        switch ($key) {
            case "url":
