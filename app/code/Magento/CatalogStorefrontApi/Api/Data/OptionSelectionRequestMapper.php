 ...
 */
final class OptionSelectionRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = OptionSelectionRequestInterface::class;
    ...
    * would be built
    *
    * @param OptionSelectionRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(OptionSelectionRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "store":
