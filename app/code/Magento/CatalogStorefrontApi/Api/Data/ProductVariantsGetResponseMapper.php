...
/**
 * Autogenerated description for ProductVariantsGetResponse class
 *
 ...
 */
final class ProductVariantsGetResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductVariantsGetResponseInterface::class;
    ...
    * would be built
    *
    * @param ProductVariantsGetResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductVariantsGetResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "items":
                $convertedArray = [];
