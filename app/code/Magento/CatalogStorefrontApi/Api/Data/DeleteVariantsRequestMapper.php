 ...
 */
final class DeleteVariantsRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteVariantsRequestInterface::class;
    ...
    * would be built
    *
    * @param DeleteVariantsRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(DeleteVariantsRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "id":
                $dto->setId((array) $value);
                break;
        }
    }
}
