 ...
 */
final class ProductReviewCountResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductReviewCountResponseInterface::class;
    ...
    * would be built
    *
    * @param ProductReviewCountResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductReviewCountResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "review_count":
                $dto->setReviewCount((int) $value);
                break;
        }
    }
}
