...
final class ProductVariantsGetRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductVariantsGetRequestInterface::class;
    ...
    * would be built
    *
    * @param ProductVariantsGetRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductVariantsGetRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "ids":
