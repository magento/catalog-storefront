...
/**
 * Autogenerated description for ImportCategoriesResponse class
 *
 ...
 */
final class ImportCategoriesResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportCategoriesResponseInterface::class;
    ...
    * would be built
    *
    * @param ImportCategoriesResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ImportCategoriesResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
