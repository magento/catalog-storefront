 ...
 */
final class DeleteCategoriesResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteCategoriesResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(DeleteCategoriesResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
