 ...
 */
final class DeleteProductsResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteProductsResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(DeleteProductsResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
