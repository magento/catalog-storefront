 ...
 */
final class RatingsMetadataResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = RatingsMetadataResponseInterface::class;
    ...
    * would be built
    *
    * @param RatingsMetadataResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(RatingsMetadataResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "items":
                $convertedArray = [];
