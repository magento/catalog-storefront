...
/**
 * Autogenerated description for ImportReviewsResponse class
 *
 ...
 */
final class ImportReviewsResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportReviewsResponseInterface::class;
    ...
    * would be built
    *
    * @param ImportReviewsResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ImportReviewsResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
