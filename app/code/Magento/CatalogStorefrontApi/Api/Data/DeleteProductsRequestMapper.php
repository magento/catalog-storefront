 ...
 */
final class DeleteProductsRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = DeleteProductsRequestInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(DeleteProductsRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "productIds":
