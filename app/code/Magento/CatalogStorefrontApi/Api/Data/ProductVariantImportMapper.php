 ...
 */
final class ProductVariantImportMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductVariantImportInterface::class;
    ...
    * would be built
    *
    * @param ProductVariantImport $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductVariantImport $dto, string $key, $value): void
    {
        switch ($key) {
            case "id":
