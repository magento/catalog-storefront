 ...
 */
final class ImportCategoryDataRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportCategoryDataRequestInterface::class;
    ...
    *
    * @return ImportCategoryDataRequest
    */
    ...
    * @param mixed $value
    */
    private function setByKey(ImportCategoryDataRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "category":
                $dto->setCategory(
