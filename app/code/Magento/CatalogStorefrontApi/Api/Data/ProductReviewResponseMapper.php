 ...
 */
final class ProductReviewResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductReviewResponseInterface::class;
    ...
    * would be built
    *
    * @param ProductReviewResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(ProductReviewResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "items":
                $convertedArray = [];
