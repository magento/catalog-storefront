 ...
 */
final class ProductReviewRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ProductReviewRequestInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ProductReviewRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "product_id":
