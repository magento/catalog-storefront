...
/**
 * Autogenerated description for ImportProductsResponse class
 *
 ...
 */
final class ImportProductsResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportProductsResponseInterface::class;
    ...
    * would be built
    *
    * @param ImportProductsResponse $dto
    * @param string $key
    * @param mixed $value
    */
