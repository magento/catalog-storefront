 ...
 */
final class UrlRewriteMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = UrlRewriteInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(UrlRewrite $dto, string $key, $value): void
    {
        switch ($key) {
            case "url":
            ...
            case "parameters":
                ...
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\CatalogStorefrontApi\Api\Data\UrlRewriteParameterMapper::class)
                        ->setData($element)
                        ->build();
                }
                $dto->setParameters($convertedArray);
                break;
        }
    }
}
