...
final class BreadcrumbMapper
{
     ...
     * @var string
     */
    private static $dtoClassName = BreadcrumbInterface::class;
    ...
    private function setByKey(Breadcrumb $dto, string $key, $value): void
    {
        switch ($key) {
            case "category_id":
                ...
                break;
            case "category_name":
                $dto->setCategoryName((string) $value);
                break;
            case "category_level":
                $dto->setCategoryLevel((int) $value);
                break;
            case "category_url_key":
                $dto->setCategoryUrlKey((string) $value);
                break;
            case "category_url_path":
                $dto->setCategoryUrlPath((string) $value);
                break;
        }
    }
}
