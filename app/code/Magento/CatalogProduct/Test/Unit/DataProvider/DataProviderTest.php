...
class DataProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Magento\CatalogProduct\DataProvider\DataProvider
     */
    private $dataProvider;

    /**
     * @var \Magento\CatalogProduct\DataProvider\Transformer|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        $this->objectManagerMock = $this->getMockBuilder(\Magento\Framework\ObjectManagerInterface::class)
            ->getMock();
        $this->transformerMock = $this->getMockBuilder(\Magento\CatalogProduct\DataProvider\Transformer::class)
        ...
        $this->dataProvider = (new ObjectManager($this))->getObject(
            \Magento\CatalogProduct\DataProvider\DataProvider::class,
            [
