...
namespace Magento\CatalogStorefrontConnector\DataProvider\Query\Category;

use Magento\Catalog\Api\Data\CategoryInterface;
use Magento\Framework\DB\Select;
use Magento\CatalogStorefrontConnector\DataProvider\Query\EavAttributeQueryBuilderFactory;
