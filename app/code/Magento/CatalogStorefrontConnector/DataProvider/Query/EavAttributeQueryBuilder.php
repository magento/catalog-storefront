...
namespace Magento\CatalogStorefrontConnector\DataProvider\Query;
 ...
 */
class EavAttributeQueryBuilder
{
    /**
     ...
     * @throws \Exception
     */
    public function build(array $entityIds, array $attributes, int $storeId): Select
    {
