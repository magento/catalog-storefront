...
namespace Magento\CatalogStorefrontConnector\Model\Logging;
...
class Debug extends \Magento\Framework\Logger\Handler\Debug
{
    ...
    /**
     * Path to the debug_extended value in the deployment config.
     */
    ...
    {
        return (bool)$this->deploymentConfig->get(ConfigOptionsList::CONFIG_PATH_DEBUG_LOGGING);
    }
